...
export default function Settings() {
  const { isGoogleConnected, connectGoogle } = useTrades();
          ...
          <CardContent className="p-6 space-y-4">
            <div className="flex items-center justify-between p-4 border border-white/10 bg-black/60 rounded-lg">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-brand-purple rounded-full flex items-center justify-center text-white font-bold shadow-glow-purple">GD</div>
                <div>
              ...
              <Button 
                variant="outline" 
                size="sm" 
                className={`${isGoogleConnected ? 'text-brand-orange hover:text-brand-orange/80' : 'text-white'} border-white/10 hover:bg-white/10`}
